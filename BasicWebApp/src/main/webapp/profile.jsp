...
<body>
					...
					<div class="col-md-6">
						...
						<div class="contact-form">
							<form id="contact-form" role="form"
								action="ProfileController?action=change" method="post"
								...
								<div class="form-group has-feedback" style="width: 400px;">
									<label for="name" style="color: gray; font-size: 15px;">User
										name</label> <br> <i class="fa fa-user" style="margin: 10px;"></i><b
 ...
 %>
								...
								<div class="form-group has-feedback" style="width: 400px;">
									<label for="name" style="color: gray; font-size: 15px;">Email
										id</label> <br> <i class="fa fa-envelope" style="margin: 10px;"></i><b
										style="color: black; font-size: 20px;"> <%
 if (email != null)
 	out.print(email);
 %>
								...
								<input type="submit"
									style="width: 400px; background-color: #39c9ed;" value="Change"
